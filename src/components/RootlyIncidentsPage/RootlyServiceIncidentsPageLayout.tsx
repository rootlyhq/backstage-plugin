...
export const RootlyServiceIncidentsPageLayout = ({ entity, organizationId }: { entity: Entity; organizationId?: string }) => {
  ...
  if (!service) {
    return (
      <Page themeId="tool">
        <Content>
          <ContentHeader textAlign="center" title={entity.metadata.name} />
          <Grid container spacing={3} direction="column">
            <Box sx={{ mx: 'auto' }} mt={2}>
              <Alert severity="error">Looks like this component is not linked to any services in Rootly</Alert>
            </Box>
          </Grid>
        </Content>
      </Page>
