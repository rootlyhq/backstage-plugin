...
rootly.com/catalog-entity-slug: enterprise-tier # Use catalog-entity-id or catalog-entity-slug. Not both.
...
| `rootly.com/catalog-entity-id` | Link to a Rootly catalog entity by UUID | - |
| `rootly.com/catalog-entity-slug` | Link to a Rootly catalog entity by slug | - |
| `rootly.com/catalog-entity-auto-import` | Set to `enabled` to auto-create catalog entity | Yes |
| `rootly.com/catalog-id` | Target catalog UUID (required for auto-import) | - |
| `rootly.com/catalog-slug` | Target catalog slug (alternative to catalog-id) | - |
| `rootly.com/catalog-description` | Description when auto-creating a catalog | - |
